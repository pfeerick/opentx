...
void extmodulePpmStart()
{
  ...
  NVIC_SetPriority(EXTMODULE_TIMER_DMA_STREAM_IRQn, EXTMODULE_TIMER_DMA_STREAM_IRQn_PRIO);
  NVIC_EnableIRQ(EXTMODULE_TIMER_CC_IRQn);
  NVIC_SetPriority(EXTMODULE_TIMER_CC_IRQn, EXTMODULE_TIMER_CC_IRQn_PRIO);
}
...
void extmoduleInvertedSerialStart(uint32_t baudrate)
{
  ...
  NVIC_SetPriority(EXTMODULE_USART_IRQn, EXTMODULE_USART_IRQn_PRIO);
